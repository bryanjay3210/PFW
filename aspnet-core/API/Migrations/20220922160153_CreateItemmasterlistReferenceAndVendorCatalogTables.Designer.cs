...
namespace API.Migrations
{
    ...
    [Migration("20220922160153_CreateItemmasterlistReferenceAndVendorCatalogTables")]
    partial class CreateItemmasterlistReferenceAndVendorCatalogTables
    {
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.ItemMasterlistReference", b =>
                {
                    ...
                    b.HasIndex(new[] { "PartNumber", "PartsLinkNumber", "OEMNumber" }, "IDX_ITEMMASTERLISTREFERENCE");
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.Product", b =>
                {
                    ...
                    b.Property<int?>("YearModelRangeFrom")
                        .HasColumnType("int");

                    b.Property<int?>("YearModelRangeTo")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex(new[] { "PartNumber", "PartDescription", "Brand", "YearModelRangeFrom", "YearModelRangeTo" }, "IDX_PRODUCT");
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.VendorCatalog", b =>
                {
                    ...
                    b.HasIndex(new[] { "VendorCode", "VendorPartNumber", "PartsLinkNumber" }, "IDX_ITEMMASTERLISTREFERENCE")
                        .HasDatabaseName("IDX_ITEMMASTERLISTREFERENCE1");
