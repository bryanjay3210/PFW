...
namespace API.Migrations
{
    ...
    [Migration("20230514075843_CreatePaymentDetailAndCustomerCreditTables")]
    partial class CreatePaymentDetailAndCustomerCreditTables
    {
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.Payment", b =>
                {
                    ...
                    b.Property<string>("AppIto")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");

                    b.Property<decimal?>("BillPayAmount")
                        .HasColumnType("decimal(12,2)");
                    ...
                    b.HasIndex(new[] { "InvoiceNumber", "CustomerId", "AccountNumber", "PaymentDate", "ReferenceNumber" }, "IDX_PAYMENT");
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.PaymentDetail", b =>
                {
                    ...
                    b.HasIndex(new[] { "PaymentId" }, "IDX_PAYMENT_DETAIL");
