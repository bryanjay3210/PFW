...
namespace API.Migrations
{
    ...
    [Migration("20230731154756_UpdatePartsPickingTables")]
    partial class UpdatePartsPickingTables
    {
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.PartsPicking", b =>
                {
                    ...
                    b.HasIndex(new[] { "PickNumber" }, "IDX_PARTS_PICKING");
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.PartsPickingDetail", b =>
                {
                    ...
                    b.Property<string>("PartsPickingNumber")
                        .IsRequired()
                        .HasMaxLength(35)
                        .HasColumnType("nvarchar(35)");
                    ...
                    b.HasIndex(new[] { "PartsPickingId", "OrderNumber", "PartNumber", "OrderId", "OrderDate" }, "IDX_PARTS_PICKING_DETAIL");
