...
namespace API.Migrations
{
    ...
    [Migration("20240623114930_AddQuantityToPartsManifestDetails")]
    partial class AddQuantityToPartsManifestDetails
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.Contact", b =>
                {
                    ...
                    b.Property<bool>("IsEmailCreditMemo")
                        .HasColumnType("bit");

                    b.Property<bool>("IsEmailOrder")
                        .HasColumnType("bit");

                    b.Property<bool>("IsEmailStatement")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.Customer", b =>
                {
                    ...
                    b.HasIndex(new[] { "PhoneNumber" }, "IDX_CUSTOMERPHONENUMBER");
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.Driver", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DriverNumberString")
                        .IsRequired()
                        .HasMaxLength(4)
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.DriverLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DriverLogNumber")
                        .IsRequired()
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
                    ...
                    b.HasIndex(new[] { "DriverId", "DriverName", "DriverLogNumber" }, "IDX_DRIVERLOG");

                    b.ToTable("DriverLogs");
                });

            modelBuilder.Entity("Domain.DomainModel.Entity.DriverLogDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "DriverLogId", "OrderId", "OrderDetailId" }, "IDX_DRIVERLOGDETAIL");

                    b.ToTable("DriverLogDetails");
                });
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.Lookup.PaymentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "Name", "Code" }, "IDX_PAYMENTTYPELOOKUP");
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.Order", b =>
                {
                    ...
                    b.Property<int>("RGAReason")
                        .HasColumnType("int");

                    b.Property<string>("RGAReasonNotes")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<int>("RGAType")
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "CustomerId", "AccountNumber", "OrderNumber", "InvoiceNumber", "WarehouseId", "PurchaseOrderNumber", "RGAType", "RGAReason" }, "IDX_ORDER");
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.OrderDetail", b =>
                {
                    ...
                    b.Property<int>("DiscountRecord")
                        .HasColumnType("int");

                    b.Property<decimal>("DiscountRecordAmount")
                        .HasColumnType("decimal(12,2)");
                    ...
                    b.Property<bool>("IsCreditMemoCreated")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("RGAInspectedCode")
                        .HasColumnType("int");

                    b.Property<string>("RGALocation")
                        .HasMaxLength(15)
                        .HasColumnType("nvarchar(15)");

                    b.Property<string>("RGAPartNumber")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");

                    b.Property<int?>("RGAState")
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "OrderId", "SalesOrderNumber", "OriginalInvoiceNumber", "BuyOutOrder", "PartNumber", "Vehicle", "CategoryId", "TrackingNumber", "IsCreditMemoCreated", "RGAInspectedCode", "RGAPartNumber", "RGALocation", "RGAState" }, "IDX_ORDERDETAIL");

                    b.ToTable("OrderDetails");
                });

            modelBuilder.Entity("Domain.DomainModel.Entity.OrderNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "OrderId" }, "IDX_ORDERNOTEORDER");
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.PartsManifest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PartsManifestNumber")
                        .IsRequired()
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
                    ...
                    b.HasIndex(new[] { "DriverId", "DriverName", "PartsManifestNumber" }, "IDX_PARTSMANIFEST");

                    b.ToTable("PartsManifests");
                });

            modelBuilder.Entity("Domain.DomainModel.Entity.PartsManifestDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("PartsManifestId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "PartsManifestId", "ProductId", "PartNumber" }, "IDX_PARTSMANIFESTDETAIL");

                    b.ToTable("PartsManifestDetails");
                });

            modelBuilder.Entity("Domain.DomainModel.Entity.PartsPicking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("PartsPickingDate")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex(new[] { "PickNumber", "StatusId", "PickStatus" }, "IDX_PARTS_PICKING");

                    b.ToTable("PartsPickings");
                });

            modelBuilder.Entity("Domain.DomainModel.Entity.PartsPickingDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PPDetailStatus")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.HasIndex(new[] { "PartsPickingId", "OrderNumber", "PartNumber", "OrderId", "OrderDate", "StatusId", "PPDetailStatus" }, "IDX_PARTS_PICKING_DETAIL");

                    b.ToTable("PartsPickingDetails");
                });
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.Product", b =>
                {
                    ...
                    b.Property<bool>("IsAPIAllowed")
                        .HasColumnType("bit");

                    b.Property<bool>("IsActive")
                        .HasColumnType("bit");

                    b.Property<bool>("IsCAProduct")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.PurchaseOrder", b =>
                {
                    ...
                    b.HasIndex(new[] { "VendorId", "VendorCode", "VendorPO", "PFWBNumber", "ReceivedDate" }, "IDX_PURCHASE_ORDER");
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.PurchaseOrderDetail", b =>
                {
                    ...
                    b.HasIndex(new[] { "PurchaseOrderId", "OrderNumber", "PartNumber", "VendorPartNumber", "OrderDate", "ReceivedDate" }, "IDX_PURCHASE_ORDER_DETAIL");
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.StockSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsCaliforniaCAProduct")
                        .HasColumnType("bit");

                    b.Property<bool>("IsCaliforniaNVProduct")
                        .HasColumnType("bit");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("bit");

                    b.Property<bool>("IsDropShipCAProduct")
                        .HasColumnType("bit");

                    b.Property<bool>("IsDropShipNVProduct")
                        .HasColumnType("bit");

                    b.Property<bool>("IsNevadaCAProduct")
                        .HasColumnType("bit");

                    b.Property<bool>("IsNevadaNVProduct")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.Vendor", b =>
                {
                    ...
                    b.Property<int>("CAPercentage")
                        .HasColumnType("int");

                    b.Property<int>("CARank")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("NVPercentage")
                        .HasColumnType("int");

                    b.Property<int>("NVRank")
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "VendorName", "VendorCode", "ContactName", "PhoneNumber", "Email", "CAPercentage", "CARank", "NVPercentage", "NVRank" }, "IDX_VENDOR");
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.DriverLog", b =>
                {
                    b.HasOne("Domain.DomainModel.Entity.Driver", "Driver")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.DriverLogDetail", b =>
                {
                    b.HasOne("Domain.DomainModel.Entity.DriverLog", "DriverLog")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.PartsManifestDetail", b =>
                {
                    b.HasOne("Domain.DomainModel.Entity.PartsManifest", "PartsManifest")
                        .WithMany()
                        .HasForeignKey("PartsManifestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.PartsPickingDetail", b =>
                {
                    ...
                    b.HasOne("Domain.DomainModel.Entity.PartsPicking", "PartsPicking")
                        .WithMany()
                        .HasForeignKey("PartsPickingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
