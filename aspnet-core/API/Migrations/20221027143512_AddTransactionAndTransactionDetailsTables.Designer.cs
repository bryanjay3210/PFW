...
namespace API.Migrations
{
    ...
    [Migration("20221027143512_AddTransactionAndTransactionDetailsTables")]
    partial class AddTransactionAndTransactionDetailsTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "Name", "Description" }, "IDX_TRANSACTION");

                    b.ToTable("Transactions");
                });

            modelBuilder.Entity("Domain.DomainModel.Entity.TransactionDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "Name", "Description" }, "IDX_TRANSACTION")
                        .HasDatabaseName("IDX_TRANSACTION1");

                    b.HasIndex(new[] { "TransactionId" }, "IDX_TRANSACTIONDETAILTRANSACTION");
            ...
            modelBuilder.Entity("Domain.DomainModel.Entity.TransactionDetail", b =>
                {
                    b.HasOne("Domain.DomainModel.Entity.Transaction", "Transaction")
                        .WithMany()
