...
import { Contact, CustomerDTO, PaymentTerm, StatementEmailParamDTO, StatementReportDTO, User } from 'src/services/interfaces/models';
...
import { ReportCustomerListComponent } from '../../report-management/report-customer-list/report-customer-list.component';
...
export class EmailModuleComponent implements OnInit, AfterViewInit {
  ...
  columns: TableColumn<CustomerDTO>[] = [
    ...
    { label: 'Statement Amount', property: 'statementAmount', type: 'number', visible: true },
    { label: 'Valid Email', property: 'validEmail', type: 'image', visible: true },
  ...
  constructor(
    ...
    let modulePermission = this.currentUser.role.rolePermissions.find(rp => rp.module.code == ModuleCode.EmailModule);
