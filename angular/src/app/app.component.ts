            ...
            children: [
              {
                ...
                route: '/apps/administration/customer-management',
              },
              {
                type: 'link',
                label: 'Product Management',
                route: '/apps/automobiles',
              },
              {
                type: 'link',
              ...
              },
              {
                ...
                route: '/apps/administration/user-management',
              },
              {
                type: 'link',
                label: 'Roles & Permissions',
                route: '/apps/administration/roles-permissions',
              }
            ]
          },
          {
            ...
            children: [
              {
                ...
                route: '/apps/system-maintenance/module-management',
              },
              {
                type: 'link',
                label: 'Lookup Management',
                route: '/apps/system-maintenance/lookup-management',
              }
            ]
          },
          {
